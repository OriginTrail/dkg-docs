...
If you are looking to build applications leveraging [knowledge assets](https://origintrail.io/products/knowledge-assets) on the OriginTrail Decentralized Knowledge Graph (DKG), the dkg.py library is the best place to start!
